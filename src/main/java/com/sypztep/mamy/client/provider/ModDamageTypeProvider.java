...
public class ModDamageTypeProvider extends FabricDynamicRegistryProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries, Entries entries) {
        ...
        entries.add(ModDamageTypes.ENERGY_BREAK, new DamageType("energy_break",0.1f));
        ...
        entries.add(ModDamageTypes.FIREBALL, new DamageType("fireball",0.1f));
        entries.add(ModDamageTypes.SHOCKWAVE_FLAME, new DamageType("shockwave_flame",0.1f));
        entries.add(ModDamageTypes.LIGHTING, new DamageType("lighting",0.1f));
    }
    @Override
