...
public interface ModEntityAttributes {
    ...
    RegistryEntry<EntityAttribute> HEALTH_REGEN = register("health_regen", 0.0, 0.0, Double.MAX_VALUE);
    RegistryEntry<EntityAttribute> PASSIVE_HEALTH_REGEN = register("passive_health_regen", 0.0, 0.0, Double.MAX_VALUE,true);
    ...
    // ========== COMBAT TYPE DAMAGE ATTRIBUTES ==========
    // Combat methods - separate from elemental types
    ...
    // Pure elemental damage types - separate from combat methods

    // Base elemental damage (flat bonuses)
    RegistryEntry<EntityAttribute> PHYSICAL_ATTACK_DAMAGE_FLAT = register("physical_attack_damage_flat", 0, 0.0, 4096);
    RegistryEntry<EntityAttribute> FIRE_ATTACK_DAMAGE_FLAT = register("fire_attack_damage_flat", 0, 0.0, 4096);
    RegistryEntry<EntityAttribute> COLD_ATTACK_DAMAGE_FLAT = register("cold_attack_damage_flat", 0, 0.0, 4096);
    ...
    RegistryEntry<EntityAttribute> PHYSICAL_ATTACK_DAMAGE_MULT = register("physical_attack_damage_mult", 0, 0.0, 10.24D);
    RegistryEntry<EntityAttribute> FIRE_ATTACK_DAMAGE_MULT = register("fire_attack_damage_mult", 0, 0.0, 10.24D);
    RegistryEntry<EntityAttribute> COLD_ATTACK_DAMAGE_MULT = register("cold_attack_damage_mult", 0, 0.0, 10.24D);
    ...
    RegistryEntry<EntityAttribute> PHYSICAL_RESISTANCE = register("physical_resistance", 0, -10.0D, 0.75D);
    ...
    RegistryEntry<EntityAttribute> COLD_RESISTANCE = register("cold_resistance", 0, -10.0D, 0.75D);

    // Elemental flat reductions
    RegistryEntry<EntityAttribute> FLAT_PHYSICAL_REDUCTION = register("flat_physical_reduction", 0, 0.0D, 20.0D);
    ...
    // General damage reduction (applied after all other calculations)
